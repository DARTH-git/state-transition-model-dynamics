...
subtitle: Appendix of 'Krijkamp EM, Alarid-Escudero F, Enns EA, Hunink MGM, Pechlivanoglou P, Jalal HJ. An multidimensional-array representation of state-transition model dynamics - Illustrative healthy-sick-dead 3-state model.'
date: "`r Sys.Date()`"
output:
