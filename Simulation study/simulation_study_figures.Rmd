...
ggplot(data_relative_combined, aes(x = n_states, time)) +
...
ggplot(data_relative_combined, aes(x = n_states, temory)) +
  geom_point(color = DARTHgreen) + 
  geom_line(color = DARTHgreen) +
...
data_combined <- rbind(time_mem_both_2D_new, data_relative_combined)
# Use the facet_wrap to make a figure
