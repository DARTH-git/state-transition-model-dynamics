...
#### Equation 11 ####
v.Costs <- rowSums(t(colSums(a.O_costs)))   # calculate the expected costs per cycle
v.QALYs <- rowSums(t(colSums(a.O_effects))) # calculate the expected QALYs per cycle
