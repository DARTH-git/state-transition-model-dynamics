...
In this section, we specify the staring age of the cohort, the number of cycles, the names of the health states and model parameters. These parameters, as described in the table, are combined in a dataframe using the `f.generate_init_params` function. 
```{r, eval = TRUE, echo = TRUE, message = FALSE, warning = FALSE}
